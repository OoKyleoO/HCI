...
class App extends React.Component{
    ...
    activeTagHandle = (url) => {
        ...
        if(/projects/.test(url)) {
            this.setState({activeTag: 'projects'})
        }
    }
                ...
                <div className='main-nav'>
                    <div className="left">
                        ...
                        <div className="nav-list">
                            ...
                            <span className={this.state.activeTag == 'projects' ? 'nav-item active' : 'nav-item'} onClick={this.routerHandle.bind(this, '/projects')}>项目</span>
                        </div>
                    </div>
